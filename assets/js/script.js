...
const imageToSwap = document.getElementById("imageToSwap");
  ...
  function isFormComplete() {
    // Implement your logic to check if the form is complete here
    // You can check if all required fields are filled out, for example.
    // Example logic (customize this according to your form):
  ...
  function showPopup() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        // You can also reload the page if that's the desired action.
        // location.reload();
      }
    });
  }
